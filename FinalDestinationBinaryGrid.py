# Final Destination 
# Easy Accuracy: 20.05% Submissions: 678 Points: 2
...
# Question: if he was at a position, can he revisit this position?
# Namely, the origin case
class Solution:
    def canReach(self, a, b, x):
        minSteps = abs(a) + abs(b)
        diff = x - minSteps
        return int(diff >= 0 and diff % 2 == 0)
